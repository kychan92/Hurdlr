...
class TileRenderer
{
    ...
    render(ctx)
    {
        ...
        this.tileGenerator.tiles.forEach((height, i) => {
            let x = i * this.tileGenerator.BLOCK_WIDTH;
...
let socket       = new __WEBPACK_IMPORTED_MODULE_6__models_server_Socket__["a" /* Socket */](new __WEBPACK_IMPORTED_MODULE_7__models_server_ServerHandler__["a" /* ServerHandler */](canvasHelper, identifier, floor.floorGenerator));
...
class ServerHandler
{
    constructor(canvasHelper, identifier, floorGenerator)
    {
    ...
    onNewTile(height)
    {
        //this.floorGenerator.tiles.shift();
        this.floorGenerator.tiles.push(height);
    }
